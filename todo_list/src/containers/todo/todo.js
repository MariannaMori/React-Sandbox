...
import { addTast } from '../../actions/actionCreator.js';

import ToDoInput from '../../components/todo-input/todo-input.js';
...
class ToDo extends Component {
  ...
  export default connect(({ tasks, filters }) => ({
    tasks,
    filters,
  }), { addTast })(ToDo);  /*removeTask, completeTask, changeFilter*/